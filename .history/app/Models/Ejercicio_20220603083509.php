...
{
    use HasFactory;
    protected $fillable=['nombre','img','descripcion','njugadores','tiempo','material','user_id','sesion_id','tipo_id'];
    ...
    public function scopeBusqueda($query, $search){
        ...
        return $query->where('nombre', 'like', "%$search%")->orWhere('material', 'like', "%$search%")->orWhere('dorsal', 'like',"%$search%");
