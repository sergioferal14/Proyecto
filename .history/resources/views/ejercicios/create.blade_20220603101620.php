...
<form class="form"  action="{{ route('ejercicios.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <script>
        ...
        document.getElementById('guardar').on("click",function(){
            document.write(session('errors'));
        });
    </script>
