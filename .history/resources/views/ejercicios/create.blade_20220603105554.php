...
<form id="formCrear" <?= isset($variabledesession) ? 'style="display:block;"' : '' ?> action="{{ route('ejercicios.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
        ...
        <div class="relative p-4 w-full max-w-5xl h-full md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div
                    ...
                    <button type="submit" onclick="errores()"
