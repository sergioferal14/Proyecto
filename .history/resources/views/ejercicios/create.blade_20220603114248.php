            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="text-2xl flex flex-row my-2" style="background-color: #0288d1;">
                    ...
                    @enderror</h3>
                        ...
                        <button type="button" style="border:solid 1px #c6d6df"
                        class="text-white mr-8 bg-transparent hover:border-gray-700 p-2 rounded hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
                        data-modal-toggle="modalCrear">
                        <i class="text-xl fa-solid fa-xmark-large " style="border:solid 1px #c6d6df">x</i>
                    </button>
