                                        ...
                                        <div>
                                            <div class="ml-2 flex justify-center">
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label inline-block text-gray-800" for="estado" name="estado" id="estado" value="2">
                                                        Publico
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label inline-block text-gray-800" for="estado" name="estado" id="estado" value="1">
                                                        Privado
                                                    </label>
                                                </div>
                                            </div>
