                                        ...
                                        <div>
                                            <div class="ml-2 flex justify-center">
                                                <div class="form-check">
                                                    <input class="form-check-input appearance-none rounded-full h-4 w-4 border border-gray-300 bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" type="radio" for="estado" name="estado" id="estado" value="2">
                                                    <label class="form-check-label inline-block text-gray-800" >
                                                        Publico
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input appearance-none rounded-full h-4 w-4 border border-gray-300 bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" type="radio" for="estado" name="estado" id="estado" value="2" checked>
                                                    <label class="form-check-label inline-block text-gray-800" for="estado">
                                                        Privado
                                                    </label>
                                                </div>
                                            </div>
