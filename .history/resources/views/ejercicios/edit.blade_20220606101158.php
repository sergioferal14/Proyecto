        ...
        @if ($errors->any())
            <script type="text/javascript">
                ...
                let oscurecerClass = document.getElementsByClassName('oscurecer');
                    ...
                    let oscuros=document.getElementsByClassName('oscuro');
                    oscuros[0].style.backgroundColor="rgba(0,0,0,0.6)";
                    oscuros[1].style.backgroundColor="rgba(0,0,0,0.6)";
                    for(let i=1;i<oscuros.length;i++){
                    oscurecerClass[i].style.add('background-color:rgba(0,0,0,0.6)');
                }
                for(let i=1;i<oscurecerClass.length;i++){
                    oscurecerClass[i].classList.add('oscurecer1');
                }
