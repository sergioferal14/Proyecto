<x-app-layout>
    ...
    <div class="mt-4 max-w-7xl mx-auto sm:px-6 lg:px-8 container">
        ...
        <div class="grid md:grid-cols-3 lg:grid-cols-4 sm:grid-cols-2"
            style="padding: 10px 30px 0; margin-left: 0;position: relative;overflow-y: visivle;overflow-x: hidden;flex-grow: 1; min-height:calc(100vh-266px)">
            <!--Aqui empieza el contenedor de  carpetas-->
            <div class="md:col-span-3 lg:col-span-1 carpetas"
