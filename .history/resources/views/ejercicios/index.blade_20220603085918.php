    ...
    <div class="mt-4 max-w-7xl mx-auto sm:px-6 lg:px-8 container">
        ...
        <div class="grid md:grid-cols-3 lg:grid-cols-4 sm:grid-cols-2"
            ...
            <div class=" sm:col-span-4 lg:col-span-3 mx-w-sm ">
                ...
                <div class="mt-2 mx-auto col-span-4 pagination-lg lg: margin-left:25% !important" style="width:100%;display:block; text-align:center !important; margin-left:25% !important;">
                    {{$ejercicios->links()}}
                </div>
