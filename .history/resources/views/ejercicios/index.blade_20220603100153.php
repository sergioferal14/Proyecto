<x-app-layout>
    ...
    @endif
              <div class="mx-auto">
                <button id="botonCrear" class="bg-sky-700 hover:bg-sky-800 text-white font-bold py-2 px-4 rounded border-3 "
                    type="button" data-modal-toggle="modalCrear" data-target="crearEjercicio">
        ...
        <div class="grid md:grid-cols-3 lg:grid-cols-4 sm:grid-cols-2"
            ...
            @endif
                ...
                @foreach ($tipos as $tip)
                    <a href="{{ route('ejercicio.index1',$tip) }}">
            ...
            <div class=" sm:col-span-4 lg:col-span-3 mx-w-sm ">
                            ...
                            <div style="border:solid 1px #0288d1;" class=" rounded p-2 formulario">
                                <div style=" padding: 10px; display:flex; " class="flex sm:flex-col md:flex-row justify-center text-center mx-auto">
                                    <div class="grid-formulario"
                                        style="align-items: center;padding: 0;margin-right:5px">
                                        <div class="div1 mr-1">
                                            <div class="text-lg flex flex-row justify-center text-center mx-auto mb-1"
                                                style="background-color: #0288d1;color:white;">
                                                Tipo
