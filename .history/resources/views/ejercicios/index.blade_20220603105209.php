    ...
    <div class="mt-4 max-w-7xl mx-auto sm:px-6 lg:px-8 container">
        ...
        <div class="my-2 grid md:grid-cols-3 mb-5">
            ...
            <div class="my-2 mb-5 mx-auto" style="text-align: center;">
                ...
                <div class="mx-auto">
                    <a href="{{route('ejercicios.create')}}" id="botonCrear" class="bg-sky-700 hover:bg-sky-800 text-white font-bold py-2 px-4 rounded border-3 " type="button" data-modal-toggle="modalCrear" data-target="crearEjercicio">
