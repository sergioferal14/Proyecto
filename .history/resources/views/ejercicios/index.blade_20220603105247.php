    ...
    <div class="mt-4 max-w-7xl mx-auto sm:px-6 lg:px-8 container">
        ...
        <div class="my-2 grid md:grid-cols-3 mb-5">
            ...
            <div class="my-2 mb-5 mx-auto" style="text-align: center;">
                ...
                <div class="mx-auto">
                    <a href="{{route('ejercicios.create',$sesion)}}" id="botonCrear" class="bg-sky-700 hover:bg-sky-800 text-white font-bold py-2 px-4 rounded border-3 " type="button" data-modal-toggle="modalCrear" data-target="crearEjercicio">
                        <i class="fa-solid fa-plus"></i>@if(isset($sesion)) Añadir Ejercicio a {{$sesion->nombre}} @else Crear Nuevo Ejercicio @endif</a>
                    
                </div>
            </div>
            <!--Aqui empieza el contenedor de los dos espacios-->
            <div class="grid md:grid-cols-3 lg:grid-cols-4 sm:grid-cols-2" style="padding: 10px 30px 0; margin-left: 0;position: relative;overflow-y: auto;overflow-x: hidden;flex-grow: 1; min-height:calc(100vh-266px)">
                        ...
                        <div style="border:1px solid #dadce0;border-radius: 6px;margin-bottom: 10px;" class="  p-2 rounded bg-white shadow-lg ml-3">
                            ...
                            <div class="grid-ejercicio" style="padding: 0;">
                                ...
                                <div class="p-2 descripcion" style="width: 400px;height:210px !important;">
                                    ...
                                    <div style="height:195px;border:solid 1px #0288d1;background-color:lightgrey;" class="p-2 overflow-y-auto">
                                        {{ $item->descripcion }}
                                        ...
                                        <div class="grid-formulario" style="align-items: center;padding: 0;margin-right:5px">
                                            ...
                                            <div class="div5 mr-1">
                                                <div style="padding-top: 10px;grid-template-columns: 6em 1fr;align-items: center;">
                                                    ...
                                                    <div>
                                                        <input disabled id="created_at" name='created_at' style="color:gray;padding: 9px 10px;width: 100%; display: block;margin: 0;outline: medium none; border-bottom: solid 1px #c6d6df;" value="2022-23-05" />
                                                    </div>
                                                </div>
                                                <div style="padding-top: 10px;grid-template-columns: 6em 1fr;align-items: center;">
                                                    <div>
                                                    ...
                                                    <div>
                                                        <input disabled id="updated_at" name='updated_at' style="color:gray;padding: 9px 10px;width: 100%; display: block;margin: 0;outline: medium none; border-bottom: solid 1px #c6d6df;" value="2022-23-05" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <button wire:click="edit({{ $item }})" class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-3 m-2 rounded mx-auto lg:whitespace-nowrap" style="width:50%;">
                                            ...
                                            <form action="{{ route('ejercicios.destroy', $item) }}" method="GET" enctype="multipart/form-data">
                                                @csrf
                                                <button class="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-3 rounded mx-auto lg:whitespace-nowrap" style="width:50%;" onclick="return confirm('Borrar el ejercicio {{ $item->nombre }} permanentemente ?')">
