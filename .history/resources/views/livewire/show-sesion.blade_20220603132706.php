<div class="mt-4 max-w-7xl mx-auto sm:px-6 lg:px-8 container">
    ...
    @else
    <h3 style="border-radius: 10px;background-color:black;text-align: center;width: 70%;margin: auto;" class="mb-3 text-white font-bold p-2 text-xl">No se enconcotró ninguna sesión.</h3>
    @endif
    <div class="mt-2 mb-4">
        {{ $sesions->links() }}
    </div>
