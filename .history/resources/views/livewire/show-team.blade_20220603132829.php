...
<div class="mt-4 max-w-7xl mx-auto sm:px-6 lg:px-8 container">
                ...
                <div class="card2">
                    ...
                    <div class="card-body bg-dark" style="color: white">
                        ...
                        <button wire:click="borrar({{ $item }})"
                            ...
                            <i class="fa-solid fa-trash" onclick="return confirm('¿Borrar el equipo {{$item->nombre}}?')"></i>Borrar</button>  
                        </div>
                    </div>
                </div>
        @endforeach
    ...
    @else
    <h3 style="border-radius: 10px;background-color:black;text-align: center;width: 50%;margin: auto;" class="mb-3 text-white font-bold p-2 text-base">No se enconcotró ningun equipo.</h3>
    @endif
    <div class="mt-2 mb-4">
        {{$teams->links()}}
    </div>
