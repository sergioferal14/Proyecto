...
<div class="mt-4 max-w-7xl mx-auto sm:px-6 lg:px-8 container">
    <div class="my-2 grid md:grid-cols-3 mb-5" >
        ...
        <div class="heading">
        <h3 style="border-radius: 10px;background-color:black;text-align: center;width: 50%;margin: auto;" class="mb-3 text-white font-bold p-2 text-3xl">Selecciona un equipo</h3>
        </div>
