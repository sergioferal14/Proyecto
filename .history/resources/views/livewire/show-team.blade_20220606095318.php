                    ...
                    <div class="card-body bg-dark" style="color: white">
                        ...
                        <div class="btns">
                          <button wire:click="edit({{ $item }})"
                            ...
                            <i class="fa-solid fa-edit"></i><span class="iconos">Editar</span> </button>
                        <button wire:click="borrar({{ $item }})"
                            class="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-3 rounded">
                            <i class="fa-solid fa-trash" onclick="return confirm('¿Borrar el equipo {{$item->nombre}}?')"></i><span class="iconos">Guardar</span> </button>  
                        </div>
                    </div>
                </div>
        @endforeach
