                ...
                <div
                    ...
                    <div
                        ...
                        <button name="btnAccion" value="1" type="submit"
                            ...
                            <i class="fa-solid fa-save"></i> <span class="iconos">Guardar</span> </button>
                        ...
                        <button name="btnAccion" value="2" type="submit"
                            ...
                            <i class="fa-solid fa-trash"></i> <span class="iconos">Borrar</span> </button>
                        ...
                        <a href="{{ route('players.index', $team) }}"
                            ...
                            <i class="fa-solid fa-user-plus"></i> <span class="iconos">Nuevo Jugadore</span> </a>
