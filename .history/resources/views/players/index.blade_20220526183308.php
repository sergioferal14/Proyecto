<x-app-layout>
    ...
    <div class="mt-4 max-w-7xl mx-auto sm:px-6 lg:px-8 container" style="border-radius:10px;background-color:white;border:1px;" >
        
        <div class="my-2 mb-5 grid md:grid-cols-2" style="min-height:calc(100vh-266px)">
            <div class=" card2 xl:w-96 ml-6 bg-white mr-2 mx-w-sm rounded overflow-hidden shadow-lg ">
