<x-jet-action-section>
    ...
    <x-slot name="content">
        <div class="max-w-xl text-base ">
            {{ __('Una vez que se elimine su cuenta,<b> todos sus equipos, jugadores , sesiones y ejercicios se eliminarán de forma permanente para usted y el resto usuarios</b>. Antes de eliminar su cuenta, descargue cualquier dato o información que desee conservar.
            ') }}
        </div>
