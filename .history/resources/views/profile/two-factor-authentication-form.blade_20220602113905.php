<x-jet-action-section>
    <x-slot name="title">
        <span class="m-2" style="white-space:nowrap">{{ __('Verificacion en dos pasos') }}</span>
    ...
    <x-slot name="content">
        <h3 class="text-lg font-bold">
            @if ($this->enabled)
                ...
                @endif
            @else
                {{ __(' No has activado la verificación en dos pasos.') }}
            @endif
        </h3>

        <div class="mt-3 max-w-xl text-base ">
            <p>
