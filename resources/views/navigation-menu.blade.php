                        ...
                        <x-slot name="trigger">
                            @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                                ...
                                <button class="flex text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-gray-300 transition flex items-center">
                                    ...
                                    <img class="h-8 w-8 rounded-full object-cover" src=" @if(Auth::user()->profile_photo_path) {{asset('storage/'.Auth::user()->profile_photo_path) }} @else {{ Auth::user()->profile_photo_url }} @endif" alt="{{ Auth::user()->name }}" />
                                </button>
                            @else
                                <span class="inline-flex rounded-md">
            ...
            <div class="flex items-center px-4">
                @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                    <div class="shrink-0 mr-3">
                        <img class="h-10 w-10 rounded-full object-cover" src=" @if(Auth::user()->profile_photo_path) {{asset('storage/'.Auth::user()->profile_photo_path) }} @else {{ Auth::user()->profile_photo_url }} @endif" alt="{{ Auth::user()->name }}" />
                    </div>
                @endif
